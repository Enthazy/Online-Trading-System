 ...
 *********************************************************************************************************/
    ...
    private String getFilePath(String fileName) {
        String filePath = "serfile" + fileName + ".ser";
        return filePath;
    }
    ...
    private <T extends Persistable> boolean hasDuplicateKeys(List<T> pList) throws EntryExistsException {

        List<Integer> newIds = this.getListOfPrimaryKeys(pList);
    ...
    private <T extends Persistable> List<Integer> getListOfPrimaryKeys(List<T> pList) {
