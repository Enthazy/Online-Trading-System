...
public class MeetingFactory {
    ...
    /**
     * To create an instance of MeetingFactory for general transaction
     *
     * @param temporary whether this MeetingFactory is for a temporary transaction
     * @param duration  between the two meetings for temporary transaction
     */
    public MeetingFactory(boolean temporary, int duration) {
    ...
    //A private method used as helper function, which creates meetings according to the attributes stored in the Meeting
    // factory.
    private List<Meeting> init() throws IOException, PersistenceException {
